...
function calculoFrete() {
	if( document.getElementById ) { // Para os browsers complacentes com o DOM W3C.
		...
		if(cepDestino !== null) {
			...
			var URL = "calcularFrete.php?cepDestino="+cepDestino+"&peso="+peso+"&valor="+valor;
			...
			ajax.onreadystatechange = function() {
				...
				if(ajax.readyState == 4) {
					if(ajax.status == 200) {
						...
						document.getElementById('valorfrete').value =resultado;
						document.getElementById('cep').value =cepDestino;
					} else {
